...
public class Computer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            imggg = savedInstanceState.getInt("imggg", imggg);
        }
        else {
        }
        ...
        thrown = (Button) findViewById(R.id.thrown);
    ...
    public void thrownC(){
        ...
        turnByturn();
        thrown.setVisibility(View.GONE);
    ...
    public void showC(){
        if(tor==1){
            if(com == 1) {
                ...
                thrown.setVisibility(View.VISIBLE);
                show.setVisibility(View.GONE);
            }else{
    ...
    private void doTheUpAnimation(int fromLevel, int toLevel) {
        ...
        if (mLevel <= toLevel) {
            ...
            Computer.this.fromLevel = toLevel;
        }
    }
    private void doTheUpAnimation1(int fromLevel1, int toLevel1) {
        ...
        if (mLevel1 <= toLevel1) {
            ...
            mUpHandler.removeCallbacks(animateUpImage);
            Computer.this.fromLevel1 = toLevel1;
        }
    }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState){
        ...
        savedInstanceState.getInt("imggg");
    }
}